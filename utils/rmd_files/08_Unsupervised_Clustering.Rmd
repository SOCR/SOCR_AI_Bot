...
```{r echo=F, fig.height=7, fig.width=10, message=F, warning=F, error=FALSE}
...
```{r echo=T, fig.width=7, fig.height=6, message=F, warning=F}
library(graphics)
...
```{r echo=T, fig.width=7, fig.height=6, message=F, warning=F, error=F}
